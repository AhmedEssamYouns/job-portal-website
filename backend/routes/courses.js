...
const { addCourse, fetchIncompletedCourses, searchCourses, deleteCourse, editCourse, enrollCourses, addCourseToWishlist, removeCourseFromWishlist } = require('../controllers/courseController');
...
router.post('/wishlist/add', addCourseToWishlist);
router.post('/wishlist/remove', removeCourseFromWishlist);
