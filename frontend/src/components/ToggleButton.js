...
import './ToggleButton.css'; // Make sure to import the CSS
import { useThemeContext } from '../context/ThemeContext';
import { useTheme } from '@mui/material';

const ToggleButton = () => {
  const theme = useTheme()
  const [isChecked, setIsChecked] = useState(theme.palette.mode == 'dark' ? true : false);
  const { toggleTheme } = useThemeContext();
  const handleToggle = () => {
    setIsChecked(toggleTheme);
    // You can also handle theme changes here if needed
  };
  ...
  return (
    <label id="theme-toggle-button">
      ...
      />
      <svg viewBox="0 0 69.667 44" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" width={80}>
        <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
          ...
          <g fill="#def8ff" transform="translate(3.585 1.325)" id="stars">
            ...
            <path transform="translate(4.575 16.238) rotate(194)" d="M.993,0,.16.12.164.465.092.5.1.546l.19.052.088.582L.928,1.06l.192-.428Z" data-name="star"></path>
          </g>
        </g>
      </svg>
    </label>
